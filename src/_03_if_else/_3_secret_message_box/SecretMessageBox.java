...
public class SecretMessageBox {
	...
	public static void main(String[] args) {
		String pass = "you're aren't";
		String message = JOptionPane.showInputDialog("what is your secret message");
		String password = JOptionPane.showInputDialog("if you get the password right you can see you're secret message");
		...
		JOptionPane.showMessageDialog(null, "nah fam");}
